...
struct RegistrationView: View {
            ...
            ZStack(alignment: .bottom) {
                ...
                Form {
                    ...
                    Section(content: {
                        ...
                        SecureField("Confirmar contraseña", text: $confPassword)
                    }, header: {
                        Text("Contraseña")
                    })
    ...
    func fieldsAreValid() -> Bool {
        guard !modelData.firstNames.isEmpty, !modelData.lastNames.isEmpty, !modelData.email.isEmpty, !modelData.password.isEmpty, !confPassword.isEmpty else {
            alertText = "Favor de completar todos los campos."
            return false
        }
        
        guard modelData.password == confPassword else {
